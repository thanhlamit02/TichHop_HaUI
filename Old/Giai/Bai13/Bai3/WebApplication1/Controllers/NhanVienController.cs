...
namespace WebApplication1.Controllers
{
    public class NhanVienController : ApiController
    {
        ...
        [HttpPost]
        public bool ThemNV(int ma, string ten, string ns, string gt,string hsl,int madv)
        {
        ...
        [HttpPut]
        public bool SuaNv(int ma, string ten, string ns, string gt, string hsl, int madv)
        {
