...
namespace WebApplication1.Controllers
{
    public class NhanVienController : ApiController
    {
        ...
        [HttpPost]        
        public bool LuuNV(int ma,string ten,string ngaysinh,string gioitinh,float hsluong,int madv)
        {
        ...
        [HttpPut]
        public bool SuuNV(int ma, string ten, DateTime ngaysinh, string gioitinh, float hsluong, int madv)
        {
